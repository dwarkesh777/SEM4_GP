        ...
        <div className="min-h-screen flex bg-slate-50">
                ...
                <div className="relative z-10 max-w-lg mb-8">
                    ...
                    >
                        ...
                        <h2 className="text-[3.5rem] font-black text-white font-heading leading-[1.1] tracking-tight mb-6">
                            Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">journey</span> starts here.
                        </h2>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 xl:p-24 relative overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100/50">
                ...
                <div className="w-full max-w-[420px] relative z-10">
                    ...
                    >
                        <h1 className="text-[2.5rem] font-black text-slate-900 mb-4 font-heading tracking-tight leading-none">Welcome Back</h1>
                    ...
                    >
                        <p className="text-slate-500 font-medium">
                            ...
                            <Link to="/signup" className="text-blue-600 font-bold hover:text-blue-700 transition-colors relative after:absolute after:-bottom-1 after:left-0 after:w-full after:h-0.5 after:bg-blue-600 after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:origin-left">
                                Sign up
                            </Link>
                        </p>
                    </motion.div>
