        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50/50 p-4 pt-24">
            <div className="w-full max-w-4xl">
                ...
                >
                    ...
                    <p className="text-slate-500 font-medium text-lg">Choose your portal to continue.</p>
                </motion.div>
                            ...
                            >
                                ...
                                >
                                    <CardHeader className="p-10 pb-6 text-center">
                                        <div className={`mx-auto w-20 h-20 ${role.bg} rounded-3xl flex items-center justify-center mb-6 transition-transform group-hover:scale-110`}>
