...
import { Mail, Lock, ArrowRight, MapPin, GraduationCap } from 'lucide-react';
...
const StudentLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast({ title: "Welcome back!", description: "Logged in successfully as a student." });
            navigate('/');
        } catch (error) {
            toast({
                title: "Login failed",
                ...
                <div className="relative z-10 p-12 max-w-xl">
                    ...
                    >
                        ...
                        <p className="text-xl text-slate-400 mb-8 leading-relaxed">
                            Find your perfect home away from home. Access thousands of verified hostels and PGs tailored for students.
                        </p>
                    ...
                    <div className="bg-white p-8 md:p-10 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-100">
                        ...
                        <div className="mt-10 text-center">
                            <p className="text-slate-500 font-medium">
                                New student?{' '}
                                <Link to="/student/signup" className="text-primary font-black hover:underline ml-1">
